...
Тестовое задание в команду kvadraOS Desktop (Команда 2).
...
системных метрик. Благодаря этому приложение можно отлаживать на macOS(то есть на моей домашней системе) и затем
собирать в Ubuntu 22.04.5 LTS без изменения frontend-кода.
